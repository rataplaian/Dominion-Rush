...
export const UNIT_DEFINITIONS: UnitDefinition[] = [
  {
    ...
    attackType: 'melee', range: 1, deploymentRule: 'not_home_row', advanceCooldownMs: 14000,
    description: 'Cheap frontline melee. Movement arrow charges in 14s; tap when ready to advance 1 cell for free.',
  },
  {
    ...
    description: 'Core invader. Movement arrow charges in 8s; tap when ready to advance 1 cell for free.',
  },
  {
    ...
    description: 'Fast invader. Movement charges in 6s; after a manual advance, the next melee hit deals +50%.',
  },
  {
    id: 'archer', name: 'Archer', shortName: 'Ar', icon: '🏹', kind: 'unit',
    manaCost: 3, maxHp: 360, attackDamage: 78, attackCooldownMs: 1300,
    attackType: 'ranged', range: 4, deploymentRule: 'any_owned', advanceCooldownMs: 18000,
    description: 'Fast ranged pressure. Movement arrow charges in 18s; tap when ready to advance 1 cell for free.',
  },
  {
    id: 'crossbow', name: 'Crossbow', shortName: 'Xb', icon: '🎯', kind: 'unit',
    manaCost: 4, maxHp: 420, attackDamage: 145, attackCooldownMs: 2300,
    attackType: 'ranged', range: 5, deploymentRule: 'any_owned', advanceCooldownMs: 22000,
    description: 'Long-range heavy shooter. Movement arrow charges in 22s; tap when ready to advance 1 cell for free.',
  },
  {
    id: 'pyromancer', name: 'Pyromancer', shortName: 'Py', icon: '🔥', kind: 'unit',
    manaCost: 5, maxHp: 390, attackDamage: 135, attackCooldownMs: 2500,
    attackType: 'ranged', range: 4, deploymentRule: 'any_owned', advanceCooldownMs: 22000, splashFactor: 0.5,
    description: 'Ranged blast with 50% splash. Movement arrow charges in 22s; tap when ready to advance 1 cell for free.',
  },
  {
    id: 'spearman', name: 'Spearman', shortName: 'Sp', icon: '🔱', kind: 'unit',
    manaCost: 3, maxHp: 520, attackDamage: 100, attackCooldownMs: 1350,
    attackType: 'ranged', range: 2, deploymentRule: 'any_owned', advanceCooldownMs: 16000,
    description: 'Short-reach support. Movement arrow charges in 16s; tap when ready to advance 1 cell for free.',
  },
  {
    ...
    description: 'Durable assault unit. Movement arrow charges in 9s; advancing primes a +75% charge hit.',
  },
  {
  ...
  },
  {
    ...
    attackType: 'ranged', range: 3, deploymentRule: 'any_owned', advanceCooldownMs: 20000, splashFactor: 0.75,
    description: 'Medium-range area damage with 75% splash. Movement arrow charges in 20s; tap when ready to advance 1 cell for free.',
  },
];
